% Produce the panels in Figure 3-figure supplement 2 of our manuscript.
...
load('../Results/Split_data/mcmc_posterior_mech_splitdata.mat','mean_post1','mean_post2','mean_post3','sd_post1','sd_post2','sd_post3','beta_post1','beta_post2','beta_post3','prob_presymp_post1','prob_presymp_post2','prob_presymp_post3')
...
figure(2); hold on;
v = violinplot([sd_post1,sd_post2,sd_post3],{'','',''},'ShowData',false,'ViolinAlpha',1);
v(1).ViolinColor = c1; v(2).ViolinColor = c2; v(3).ViolinColor = c3;
v1 = v(1).ViolinPlot; v2 = v(2).ViolinPlot; v3 = v(3).ViolinPlot;
ylim([0,10])
...
figure(1); export_fig Figures/figure3_supp2/figure3_supp2A.pdf -nocrop -painters -transparent
figure(2); export_fig Figures/figure3_supp2/figure3_supp2B.pdf -nocrop -painters -transparent
figure(3); export_fig Figures/figure3_supp2/figure3_supp2C.pdf -nocrop -painters -transparent
figure(4); export_fig Figures/figure3_supp2/figure3_supp2D.pdf -nocrop -painters -transparent
