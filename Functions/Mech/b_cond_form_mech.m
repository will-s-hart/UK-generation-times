function b_cond = b_cond_form_mech(x,t_inc,household_size,asymp,params)
    ...
    f_m = alpha*C*beta_indiv_m.*(1-betacdf(-x_m./t_inc_m,k_P,k_E));
    f_p = C*beta_indiv_p.*(1-gamcdf(x_p,k_I,1/(k_I*mu)));
