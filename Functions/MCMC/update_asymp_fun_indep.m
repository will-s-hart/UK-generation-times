function [data_struct_augmented_new,ll_household_new,acceptance] = update_asymp_fun_indep(theta,data_struct_augmented_old,ll_household_old,ll_household_form,t_i_prop_sd_asymp)
    ...
    acceptance.overall = mean(accept_households(asymp_in_household&(no_infected_in_household>1))); %Only include households with at least one asymptomatic and one other infection so this step is non-trivial
