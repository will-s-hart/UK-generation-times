function [theta_mat,ll_vec,output] = fit_params(no_steps,steps_keep,update_theta,update_infection,update_onset,update_asymp,empirical_summary_form,theta_init,data_struct_augmented_init,ll_household_init,plotting)
    ...
    empirical_summary_mat = zeros(no_steps_kept,3); %estimated mean/sd of realised household generation times, and the presymptomatic proportion of transmissions
    ...
    output.empirical_summary_mat = empirical_summary_mat;
end